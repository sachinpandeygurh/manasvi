...
export default function Search({text,modelName, modelbody, dropitems=false , dropinput1="", dropinput2=""}) {
  ...
  return (
    <View style={{ flexDirection: "column", alignItems: "center", justifyContent: "center",}}>
       <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "center", width: responsiveWidth (90), }}>
        <View style={{ borderColor: "#22355C", borderWidth: 1, borderRadius: 7, width: responsiveWidth(75), backgroundColor: "#0F1E3E", flexDirection: "row", alignItems: "center", justifyContent: "flex-start", padding: 6, marginHorizontal: "2%" }}>
          ...
          <TextInput style={{ paddingHorizontal: 10, color: "#FBCE6B" }} placeholder={text} placeholderTextColor='#ffffff' />
        </View>
   ...
   {modelbody}
    ...
    {dropitems&&(  <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between", flex: 1, width: responsiveWidth (92), marginVertical:"2%" }}>
        <View style={{ borderColor: "#22355C", borderWidth: 1, borderRadius: 7, width: responsiveWidth(40), backgroundColor: "#0F1E3E", flexDirection: "row", alignItems: "center", justifyContent: "flex-start", padding: 6, marginHorizontal: 0 }}>
          ...
          <TextInput style={{ paddingHorizontal: 10, color: "#FBCE6B" }} placeholder={dropinput1} placeholderTextColor='#E9E9E982' />
        </View>
        <View style={{ borderColor: "#22355C", borderWidth: 1, borderRadius: 7,  width: responsiveWidth(40), backgroundColor: "#0F1E3E", flexDirection: "row", alignItems: "center", justifyContent: "flex-start", padding: 6, marginHorizontal: 0 }}>
          <MaterialIcons name="view-day"  size={24} color="#E9E9E982" />
          <TextInput style={{ paddingHorizontal: 10, color: "#FBCE6B" }} placeholder={dropinput2} placeholderTextColor='#E9E9E982' />
        </View>
      </View>)}
    </View>
  )
