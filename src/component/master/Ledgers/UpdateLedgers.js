...
const UpdateLedgers = () => {
    ...
    return (
        <View style={styles.centeredView}>
            <Animatable.View animation="slideInDown" style={styles.mainContainer} >
                <InputField label="Name" text='Name' type="text" id="name" />
                <CustomButton title="Update Ledgers Name" />
                <InputField label="Password" text='Password123' type="text" id="name" />
                ...
                <CustomButton title="Update Info" />
            </Animatable.View>
        </View>
    );
};
